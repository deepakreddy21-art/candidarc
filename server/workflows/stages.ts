...
const TRANSITIONS: Partial<Record<WorkflowStage, WorkflowStage[]>> = {
  ...
  RESEARCH_RUNNING: ["V0_GENERATING", "RESEARCH_REVIEW_REQUIRED", "RESEARCH_COMPLETED", "CANCELLED", "FAILED"],
  ...
  V0_READY: ["FINAL_QA_RUNNING", "HR_AUDIT_1_RUNNING", "CANCELLED", "FAILED"],
  ...
  FINAL_QA_RUNNING: ["FINAL_READY", "FINAL_QA_FAILED", "V4_GENERATING", "CANCELLED", "FAILED"],
