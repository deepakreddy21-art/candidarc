...
def http_status_for(code: str) -> int:
    if code in {MISSING_CREDENTIALS, MOCK_FORBIDDEN_IN_PRODUCTION, PROVIDER_UNAVAILABLE, PROVIDER_TIMEOUT}:
        return 503
    ...
    if code == IDEMPOTENCY_KEY_REUSED:
        return 409
    if code in {CROSS_TENANT_EVIDENCE, CROSS_OWNER_EVIDENCE, EXPERIMENTAL_DISABLED}:
        return 403
    return 500
